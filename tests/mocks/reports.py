...
@classmethod
def get_area_404(cls, url, use_redis=True, timeout=None):
    return [
        {"miembros": [
            {"cod_cce": 5610,
         ...
         "unidad": {"nombre": "AREA ARIA", "codigo": 649387,
                    "nombre_corto": "A.LING."}}]

@classmethod
def get_dept_404(cls, url, use_redis=True, timeout=None):
    return [
        {"miembros": [
            {"cod_cce": 5610,
             "cod_cce__descripcion": "Profesor Titular Universidad",
             "cod_persona__apellido1": "DIAZ",
             "cod_persona__nombre": "PABLO", "cod_persona": 5,
             "cod_cce__descripcion_corta": "T.U.",
             "cod_persona__apellido2": "ROMERO"},
            {"cod_cce": 5610,
             "cod_cce__descripcion": "Profesor Titular Universidad",
             "cod_persona__apellido1": "SEXTO",
             "cod_persona__nombre": "FELIPE", "cod_persona": 6,
             "cod_cce__descripcion_corta": "T.U.",
             "cod_persona__apellido2": "RODRIGUEZ"},
            {"cod_cce": 5610,
             "cod_cce__descripcion": "Profesor Titular Universidad",
             "cod_persona__apellido1": "RUIZ",
             "cod_persona__nombre": "VANESA", "cod_persona": 7,
             "cod_cce__descripcion_corta": "T.U.",
             "cod_persona__apellido2": "GARCIA"}],
         "unidad": {"nombre": "DEPARTAMENTO DEPARTAMENTAL", "codigo": 649387,
